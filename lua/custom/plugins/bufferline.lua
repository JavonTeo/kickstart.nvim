return {
	...
	config = function()
		...
		vim.keymap.set('n', '<leader>b1', function() bufferline.go_to(1, true) end, { desc = '[B]uffer [1]' })
		vim.keymap.set('n', '<leader>b2', function() bufferline.go_to(2, true) end, { desc = '[B]uffer [2]' })
		vim.keymap.set('n', '<leader>b3', function() bufferline.go_to(3, true) end, { desc = '[B]uffer [3]' })
		vim.keymap.set('n', '<leader>b4', function() bufferline.go_to(4, true) end, { desc = '[B]uffer [4]' })
		vim.keymap.set('n', '<leader>b5', function() bufferline.go_to(5, true) end, { desc = '[B]uffer [5]' })
		vim.keymap.set('n', '<leader>b6', function() bufferline.go_to(6, true) end, { desc = '[B]uffer [6]' })
		vim.keymap.set('n', '<leader>b7', function() bufferline.go_to(7, true) end, { desc = '[B]uffer [7]' })
		vim.keymap.set('n', '<leader>b8', function() bufferline.go_to(8, true) end, { desc = '[B]uffer [8]' })
